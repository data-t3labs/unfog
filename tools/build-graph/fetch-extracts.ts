...
/** Canadian provinces / territories: bare Geofabrik ids (no `canada/` prefix). */
export const CANADA = ['alberta', 'british-columbia', 'manitoba', 'new-brunswick', 'newfoundland-and-labrador', 'northwest-territories', 'nova-scotia', 'nunavut', 'ontario', 'prince-edward-island', 'quebec', 'saskatchewan', 'yukon'];
